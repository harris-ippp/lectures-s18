...
### `ls` options
* To include file sizes in the list use option `-o`:
```bash
$ ls -o
TODO
...
* To include "human readable" file sizes use option `-oh`:
```bash
eric@laptop:~/harris-ippp$ ls -oh
TODO

```

### `ls` arguments
* To only include csv files:
```bash
$ ls -oh *.csv
TODO
