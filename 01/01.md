...
* What about more complicated searched?
...
* But command line will remain relevant in two ways:
    ...
    * The tools we've covered (`grep`, `wc`, `curl`, etc.) will remain important for a fast and efficient first pass in programming and data analysis
:::
