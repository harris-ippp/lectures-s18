...
* They power much of the internet: blogs, consumer applications, health services, etc.
...
2. No non-prime attribute of the tale may be dependent on a proper subset of any candidate key.
...
* Meaningful and carefully select a *primary key*.
